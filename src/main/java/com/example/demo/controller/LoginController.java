...
public class LoginController {
	...
	public String signup(@ModelAttribute("item") Users item) {
		
		return "true";
	}
	@RequestMapping("/create-users")
	public String create(@ModelAttribute("item") Users item, Model model, @RequestParam("image") MultipartFile photo
			,@RequestParam("passwordcf") String passwordcf, @RequestParam("password") String password
